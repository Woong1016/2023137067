...
public class test_002 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(answer); // answer 를 debug.Log에 출력시킨다.

        int n1 = 8;     //정수 n1 선언 후 값 8을 입력
        int n2 = 9;     //정수 n2 선언 후 값 9을 입력
        int answer2;    //정수 answer2 선언
        answer2 = n1 + n2;  //정수 answer2에 n1과 n2 더한값을 입력  
        Debug.Log(answer2); //answer2를 debug.Log에 출력시킨다.

        int answer3 = 10;   // 정수 answer3 선언 후 값 10을입력
        ...
        Debug.Log(answer3); // answer3를 Debug.Log에 출력시킨다
